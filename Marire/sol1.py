...
+=======================+======================+
| Starea Vremii(Soare)  |               0.1073 |
+-----------------------+----------------------+
| Starea Vremii(Noros)  |               0.5650 |
+-----------------------+----------------------+
| Starea Vremii(Ploios) |               0.3277 |
+-----------------------+----------------------+
'''
...
cpd_ploaie = TabularCPD(variable='Ploaie', variable_card=2, 
                        ...
                        evidence_card=[3, 3],
                        values=[[0.8, 0.8, 0.9, 0.4, 0.4, 0.4, 0.1, 0.1, 0.2],  # Nu
                                [0.2, 0.2, 0.1, 0.6, 0.6, 0.6, 0.9, 0.9, 0.8]], # Da
                        state_names={'Ploaie': ['Nu', 'Da'],
                                     'Starea Vremii': ['Soare', 'Noros', 'Ploios'],
